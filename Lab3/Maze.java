...
public abstract class Maze {
    ...
    public abstract Set getListenerSet(); 
    /**
    ...
    // adds a remote client at the specified position and direction
    public abstract void addRemoteClient(RemoteClient newClient, Point clientPosition, Direction clientOrientation);
    ...
    //public interface to check if moving forwards is allowed
    public abstract boolean checkMoveClientForward(Client client);
    ...
    // public interface to check if moving backwards is allowed
    public abstract boolean checkMoveClientBackward(Client client);
    ...
    /** Method to notifyClientFire*/
    public abstract void notifyClientFiredPublic(Client c);
