...
public class ScoreTableModel implements TableModel, MazeListener {
        ...
        public class ScoreWrapper implements Comparable {
                ...
                // added function to set current score
        ...
        //made clientMap visible to the maze to update score properly
        ...
        public void changeScore(Client c, int mod){
            assert(c != null);
            Object o = clientMap.get(c);
            assert(o instanceof ScoreWrapper);
            scoreSet.remove(o);
            ScoreWrapper s = (ScoreWrapper)o;
            s.setScore(mod);
