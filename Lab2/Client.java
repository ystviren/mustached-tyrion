...
public abstract class Client {
        ...
        public int getClientScore(Client c){
        	ScoreTableModel.ScoreWrapper o = (ScoreTableModel.ScoreWrapper) ScoreTableModel.clientMap.get(c);
        	return o.getScore();
        }
        
        public void clientSetScore(Client c, int mod){
        	ScoreTableModel.ScoreWrapper o = (ScoreTableModel.ScoreWrapper) ScoreTableModel.clientMap.get(c);
        	o.setScore(mod);
        }
